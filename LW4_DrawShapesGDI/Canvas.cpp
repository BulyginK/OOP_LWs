// frolov-lib.ru/books/bsp/v14/ch2_3.htm
#include "Canvas.h"
...
// RECT - структура, кот описывает прямоуголник с помощью четырёх значений типа int
RECT CCanvas::GetCircleRect(SPoint center, double radius) { 
    RECT rc;
